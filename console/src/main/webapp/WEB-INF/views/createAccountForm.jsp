        ...
        <form:form id="form" name="form" method="post" action="new" modelAttribute="accountFormBean" cssClass="form-horizontal col-lg-10 col-lg-offset-1" onsubmit="return validate();">
            ...
            <fieldset>
                ...
                <div id="create_org_div" class="create_org_block">
                    ...
                    <link rel="stylesheet" href="/console/public/libraries.css">
                    <link rel="stylesheet" href="/console/public/app.css">
                    <style>
                      .area {
                        margin: 2em;
                        background: white;
                    ...
                    <script src="/console/public/libraries.js"></script>
                    <script src="/console/public/templates.js"></script>
                    <script src="/console/public/app.js"></script>
